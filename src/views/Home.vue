<template>
  <div class="relative">
    <div  class="absolute opacity-75 w-full h-full " 
    style="background-image:url('images/background1.jpg'); z-index: -5; background-size: cover;" ></div>

  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto  my-0 relative">
    
   

	<!--Main Col-->
	<div id="profile" class="w-full my-32 lg:my-0 lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-90 mx-6 lg:mx-0">
	

		<div class="p-4 md:p-12 text-center lg:text-left">
			<!-- Image for mobile view-->
			<div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('images/foreground1.jpg')"></div>
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="images/foreground1.jpg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
